...
// One full-height panel per trip: its photo behind a veil, the title with
// duration and price on the left and the amenities as chips on the right.
// The lime is the button's alone.
