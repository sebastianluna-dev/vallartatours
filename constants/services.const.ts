...
export const SERVICES: readonly Service[] = [
  ...
  },
  {
    ...
    port: "vallarta",
    season: null,
    amenities: ["waterfall", "safety", "snorkel", "lunch", "openBar", "guide"],
    bring: ["swimsuit", "towel", "waterShoes", "sunscreen", "cap", "cash"],
    reviewPhoto: REVIEW_PHOTOS.friends,
  },
  {
    slug: "islas-marietas",
    ...
    port: "nuevoVallarta",
    season: null,
    amenities: ["breakfast", "snorkel", "safety", "lunch", "guide", "kayak"],
    bring: ["swimsuit", "towel", "sunscreen", "cap", "sunglasses", "waterShoes"],
    reviewPhoto: REVIEW_PHOTOS.family,
  },
  {
